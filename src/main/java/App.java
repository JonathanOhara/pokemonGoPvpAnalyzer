...
public class App {
    ...
    private static final String DEFAULT_LEADS = "swampert:19,giratina_altered:13,poliwrath:12,articuno:11,venusaur:10,snorlax:8,togekiss:8,muk_alolan:8,clefable:6,melmetal:6";
